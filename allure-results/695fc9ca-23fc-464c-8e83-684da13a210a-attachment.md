    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "16563 $515.50 $515.50" [ref=e59]:
              - cell "16563" [ref=e60]:
                - link "16563" [ref=e61] [cursor=pointer]:
...
```ts
  ...
  4  | import { newBill } from '../../test-data/billData';
  5  | 
  ...
  16 |   });
  17 | 
  18 |   test('Successful Bill Pay', async ({ pm }) => {
  19 | 
  ...
  26 | 
  27 |     const balanceBeforePay = await pm.overviewPage.getAccountBalance(accountId);
  28 | 
  29 |     await pm.billPayPage.goToBillPayPage();
  30 | 
  31 |     await pm.billPayPage.payBill(newBill, accountId);
  32 |     await pm.billPayPage.waitForBillPayComplete();
  33 |     await pm.billPayPage.expectBillPayComplete(accountId, newBill.amount);
  34 | 
  ...
  39 | 
> 40 |     expect(balanceAfterPay).toBeCloseTo(balanceBeforePay - parseFloat(newBill.amount), 2);
     |                             ^ Error: expect(received).toBeCloseTo(expected, precision)
  41 | 
  42 |   });
  43 | 
