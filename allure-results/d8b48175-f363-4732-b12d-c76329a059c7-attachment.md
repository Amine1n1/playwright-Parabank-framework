...
- Name: combined/withdraw.combined.spec.ts >> Withdraw Tests API + UI >> Withdraw funds Successful using API and validation by UI
- Location: tests/combined/withdraw.combined.spec.ts:17:7
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine_1783196109762 This username already exists."':
      - cell "Username:"
      - cell "amine_1783196109762":
        - textbox: amine_1783196109762
