    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "18783 $415.50 $415.50" [ref=e59]:
              - cell "18783" [ref=e60]:
                - link "18783" [ref=e61] [cursor=pointer]:
                  - /url: activity.htm?id=18783
              - cell "$415.50" [ref=e62]
              - cell "$415.50" [ref=e63]
            - row "18894 $100.00 $100.00" [ref=e64]:
              - cell "18894" [ref=e65]:
                - link "18894" [ref=e66] [cursor=pointer]:
...
```ts
  ...
  18 |   }
  19 | 
  20 |   async expectBalanceNewAccount(expectedBalance: string) {
  21 |     const balance = await this.Locator('#accountTable tbody tr').last().locator('td').nth(1).innerText();
  22 | 
> 23 |     expect(balance).toBe(expectedBalance);
     |                     ^ Error: expect(received).toBe(expected) // Object.is equality
  24 |   }
  25 | }
```