...
Locator: locator('#customer.firstName.errors')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('#customer.firstName.errors')
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine1782502355845"':
      - cell "Username:"
      - cell "amine1782502355845":
        - textbox: amine1782502355845
      - cell
    - row "Password:":
      - cell "Password:"
      - cell:
