...
- Name: combined/checkTransactionInfo.combined.spec.ts >> Check Transaction Infos Tests API + UI >> Transfer Funds, use the API to get the TransactionId and Check using UI, if the transaction is available and Infos are correct
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine_1783196109777 This username already exists."':
      - cell "Username:"
      - cell "amine_1783196109777":
        - textbox: amine_1783196109777
