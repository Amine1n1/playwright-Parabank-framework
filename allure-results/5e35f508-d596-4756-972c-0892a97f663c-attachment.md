...
```
Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'Find Transactions' }) resolved to 4 elements:
    1) <button type="submit" id="findById" class="button">↵⇆⇆⇆⇆⇆Find Transactions↵⇆⇆⇆⇆</button> aka getByRole('button', { name: 'Find Transactions' }).first()
    2) <button type="submit" class="button" id="findByDate">↵⇆⇆⇆⇆⇆Find Transactions↵⇆⇆⇆⇆</button> aka locator('#findByDate')
    3) <button type="submit" class="button" id="findByDateRange">↵⇆⇆⇆⇆⇆Find Transactions↵⇆⇆⇆⇆</button> aka locator('#findByDateRange')
    4) <button type="submit" class="button" id="findByAmount">↵⇆⇆⇆⇆⇆Find Transactions↵⇆⇆⇆⇆</button> aka locator('#findByAmount')

Call log:
  - waiting for getByRole('button', { name: 'Find Transactions' })
      ...
      - generic [ref=e50]:
        ...
        - generic [ref=e52]:
          - generic [ref=e53]:
            ...
            - combobox [ref=e54]:
              - option "45312" [selected]
              - option "45645"
          - separator [ref=e55]
          - generic [ref=e56]:
            - text: "Find by Transaction ID:"
            - textbox [active] [ref=e57]: "47998"
