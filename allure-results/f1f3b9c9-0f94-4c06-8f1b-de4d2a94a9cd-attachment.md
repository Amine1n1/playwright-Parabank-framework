...
- Name: api/accounts.api.spec.ts >> Open Account Tests >> Deposit Funds into an Account Successfull 
- Location: tests/api/accounts.api.spec.ts:171:8
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine1782756104017 This username already exists."':
      - cell "Username:"
      - cell "amine1782756104017":
        - textbox: amine1782756104017
