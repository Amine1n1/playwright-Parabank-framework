...
- Name: api/accounts.api.spec.ts >> Accounts Tests >> Open new Account Failed using API Endpoint createAccount, invalid customerId
- Location: tests/api/accounts.api.spec.ts:58:7
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine_1783197931936 This username already exists."':
      - cell "Username:"
      - cell "amine_1783197931936":
        - textbox: amine_1783197931936
