    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "64626 $742.75 $742.75" [ref=e59]:
              - cell "64626" [ref=e60]:
                - link "64626" [ref=e61] [cursor=pointer]:
                  - /url: activity.htm?id=64626
              - cell "$742.75" [ref=e62]
              - cell "$742.75" [ref=e63]
...
```ts
  ...
  47 | 
  48 |     console.log(createNewAccountBody);
  49 | 
  50 |     expect(createNewAccountBody.customerId).toBe(customerId);
> 51 |     expect(createNewAccountBody[1]).toContain('balance');
     |                                     ^ Error: expect(received).toContain(expected) // indexOf
  52 |    
  53 |   });
  54 | 
