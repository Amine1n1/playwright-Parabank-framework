...
- Name: api/accounts.api.spec.ts >> Accounts Tests >> Deposit Funds into an Account Successfull 
- Location: tests/api/accounts.api.spec.ts:176:8
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine_1783199180906 This username already exists."':
      - cell "Username:"
      - cell "amine_1783199180906":
        - textbox: amine_1783199180906
