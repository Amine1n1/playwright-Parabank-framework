    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "26664 $415.50 $415.50" [ref=e59]:
              - cell "26664" [ref=e60]:
                - link "26664" [ref=e61] [cursor=pointer]:
                  - /url: activity.htm?id=26664
              - cell "$415.50" [ref=e62]
              - cell "$415.50" [ref=e63]
            - row "26775 $100.00 $100.00" [ref=e64]:
              - cell "26775" [ref=e65]:
                - link "26775" [ref=e66] [cursor=pointer]:
...
```ts
  ...
  36 | 
  37 |     console.log(createdAccountId);
  38 | 
  39 |     await pm.overviewPage.goToOverviewPage();
  40 | 
  41 |     await pm.overviewPage.waitForTableFilled();
  42 | 
  43 |     await pm.overviewPage.expectBalanceNewAccount('$100.00', createdAccountId);
  44 | 
  45 |     const accountBalanceAfter = pm.overviewPage.getAccountBalance(fromAccount);
  46 | 
  47 |     console.log(accountBalanceAfter);
  48 |     console.log(accountBalanceBefore);
  49 | 
> 50 |     expect(accountBalanceAfter).toBe(accountBalanceBefore -100);
     |                                 ^ Error: expect(received).toBe(expected) // Object.is equality
  51 |   });
  52 | 
  53 | });
