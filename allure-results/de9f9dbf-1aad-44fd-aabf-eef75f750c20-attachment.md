            ...
            - row "06-29-2026 Funds Transfer Sent $35.00" [ref=e60]:
              ...
              - cell "Funds Transfer Sent" [ref=e62]:
                - link "Funds Transfer Sent" [ref=e63] [cursor=pointer]:
                  - /url: /parabank/transaction.htm?id=52771
              - cell "$35.00" [ref=e64]
              - cell [ref=e65]
  - generic [ref=e67]:
    - list [ref=e68]:
...
```ts
  ...
  66 | 
  67 |     const txLength = (await pm.findTransactionPage.getAllTransactions()).length;
  68 | 
> 69 |     expect(txLength).toBeGreaterThan(0);
     |                      ^ Error: expect(received).toBeGreaterThan(expected)
  70 |     expect(tx[1]).toContain('	Funds Transfer Sent');
  71 |     
  72 |   });
  73 | });
```