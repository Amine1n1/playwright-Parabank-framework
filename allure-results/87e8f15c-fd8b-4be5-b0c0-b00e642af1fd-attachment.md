    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "24444 $415.50 $415.50" [ref=e59]:
              - cell "24444" [ref=e60]:
                - link "24444" [ref=e61] [cursor=pointer]:
                  - /url: activity.htm?id=24444
              - cell "$415.50" [ref=e62]
              - cell "$415.50" [ref=e63]
            - row "24555 $100.00 $100.00" [ref=e64]:
              - cell "24555" [ref=e65]:
                - link "24555" [ref=e66] [cursor=pointer]:
...
```ts
  ...
  4  | 
  5  | test.describe('Open Account Tests', () => {
  6  | 
  ...
  17 |   });
  18 | 
  19 |   test('Open Account Successful', async ({ pm }) => {
  20 |     
  21 |     const accounts = await pm.overviewPage.getAllAccounts();
  22 | 
  23 |     const fromAccount = accounts[0];
  24 | 
  25 |     console.log(accounts);
  26 | 
  27 |     const accountBalanceBefore = await pm.overviewPage.getAccountBalance(fromAccount);
  28 | 
  ...
  38 | 
  39 |     await pm.overviewPage.expectBalanceNewAccount('$100.00', createdAccountId);
  40 | 
  41 |     const accountBalanceAfter = pm.overviewPage.getAccountBalance(fromAccount);
  42 | 
  43 |     console.log(accountBalanceAfter);
  44 |     console.log(accountBalanceBefore);
  45 | 
> 46 |     expect(accountBalanceAfter).toBe(accountBalanceBefore -100);
     |                                 ^ Error: expect(received).toBe(expected) // Object.is equality
  47 |   });
  48 | 
  49 | });
