    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "39762 $742.75 $742.75" [ref=e59]:
              - cell "39762" [ref=e60]:
                - link "39762" [ref=e61] [cursor=pointer]:
                  - /url: activity.htm?id=39762
              - cell "$742.75" [ref=e62]
              - cell "$742.75" [ref=e63]
...
> 32 |     const responseBody = await response.json();
  ...
  34 | 
  35 |     expect(responseBody.responseCode).toBe(200);
  36 | 
  37 |     await pm.overviewPage.goToOverviewPage();
  38 |     await pm.overviewPage.waitForTableFilled();
  39 | 
  40 |     const balanceAfterPay = await pm.overviewPage.getAccountBalance(accountId);
  41 | 
  42 |     expect(balanceAfterPay).toBeCloseTo(balanceBeforePay - amount, 2);
  43 | 
  44 |   });
  45 | 
  46 | });
