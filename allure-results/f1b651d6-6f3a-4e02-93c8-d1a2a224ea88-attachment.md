...
Locator: locator('[id="customer.password.errors"]')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('[id="customer.password.errors"]')
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine1782505011723"':
      - cell "Username:"
      - cell "amine1782505011723":
        - textbox: amine1782505011723
      - cell
    - row "Password:":
      - cell "Password:"
      - cell:
