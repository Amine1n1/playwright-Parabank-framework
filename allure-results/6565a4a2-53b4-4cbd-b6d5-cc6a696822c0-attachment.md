...
```ts
  ...
  67 |     console.log(fromAccountBalanceBeforeTransfer);
  68 |     console.log(fromAccountBalanceAfterTransfer);
  69 |     expect(fromAccountBalanceAfterTransfer).toBeCloseTo(fromAccountBalanceBeforeTransfer - amount, 2);
  70 | 
> 71 |     expect(toAccountBalanceAfterTransfer).toBeCloseTo(toAccountBalanceBeforeTransfer + amount, 2);
     |                                           ^ Error: expect(received).toBeCloseTo(expected, precision)
  72 |     
  73 |   });
  74 | });
