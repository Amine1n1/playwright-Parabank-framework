...
Locator: locator('[id="repeatedPassword.errors"]')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for locator('[id="repeatedPassword.errors"]')
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine1782503714424"':
      - cell "Username:"
      - cell "amine1782503714424":
        - textbox: amine1782503714424
      - cell
    - row "Password:":
      - cell "Password:"
      - cell:
