...
- Name: api/login.api.spec.ts >> Login Tests API >> Failed Bill Pay using API Endpoint billpay, invalid accountId used
- Location: tests/api/login.api.spec.ts:25:7
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine1782756103987 This username already exists."':
      - cell "Username:"
      - cell "amine1782756103987":
        - textbox: amine1782756103987
