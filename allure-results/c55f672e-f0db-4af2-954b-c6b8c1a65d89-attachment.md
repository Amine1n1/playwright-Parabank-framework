...
- Name: api/billPay.api.spec.ts >> Bill Pay API Tests >> Failed Bill Pay using API Endpoint billpay, invalid accountId used
- Location: tests/api/billPay.api.spec.ts:40:7
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine_1783198339282 This username already exists."':
      - cell "Username:"
      - cell "amine_1783198339282":
        - textbox: amine_1783198339282
