...
- Name: api/accounts.api.spec.ts >> Accounts Tests >> Transfer funds Failed using API Endpoint createAccount, invalid fromAccountId
- Location: tests/api/accounts.api.spec.ts:111:8
...
- table:
  - rowgroup:
    ...
    - row:
      - cell
    - 'row "Username: amine_1783199156572 This username already exists."':
      - cell "Username:"
      - cell "amine_1783199156572":
        - textbox: amine_1783199156572
