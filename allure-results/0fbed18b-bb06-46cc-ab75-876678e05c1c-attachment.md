    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "33879 $515.50 $515.50" [ref=e59]:
              - cell "33879" [ref=e60]:
                - link "33879" [ref=e61] [cursor=pointer]:
...
> 54 |     const transactionId = getTransactionsAccountBody.id.toString();
  ...
  58 | 
  59 |     const tx = await pm.findTransactionPage.getAllTransactions();
  60 | 
  61 |     expect(tx[0]).toContain('	Funds Transfer Sent');
  62 |     
  63 |   });
  64 | });
```