    ...
    - generic [ref=e27]:
      ...
      - generic [ref=e50]:
        ...
        - table [ref=e52]:
          ...
          - rowgroup [ref=e58]:
            - row "34878 $515.50 $515.50" [ref=e59]:
              - cell "34878" [ref=e60]:
                - link "34878" [ref=e61] [cursor=pointer]:
...
```ts
  ...
  55 | 
> 56 |     const transactionId = getTransactionsAccountBody.id.toString();
     |                                                         ^ TypeError: Cannot read properties of undefined (reading 'toString')
  57 | 
  58 |     await pm.findTransactionPage.goToTxPage();
  59 |     await pm.findTransactionPage.waitForTableFilled();
  60 | 
  61 |     await pm.findTransactionPage.findTransactionById(transactionId, fromAccount);
  62 | 
  63 |     const tx = await pm.findTransactionPage.getAllTransactions();
  64 | 
  65 |     const txLength = pm.findTransactionPage.getAllTransactions();
  66 | 
  67 |     expect(txLength).toBeGreaterThan(0);
  68 |     expect(tx[0]).toContain('	Funds Transfer Sent');
  69 |     
  70 |   });
  71 | });
```